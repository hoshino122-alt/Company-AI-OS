...
define config.name = _("Company_AI_OS_DAY38")
...
define build.name = "Company_AI_OS_DAY38"
...
define config.save_directory = "Company_AI_OS_DAY38-1786000148"
